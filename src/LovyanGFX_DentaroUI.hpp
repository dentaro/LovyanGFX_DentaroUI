...
public:
    ...
    void setFlick( int _FlickUiID, int _LeftBtnUiID, int _RightBtnUiID);//キーボード用プリセッ；
    void setFlick( int _charMode, int _FlickUiID, int _LeftBtnUiID, int _RightBtnUiID);
    void flickUpdate( LGFX* _lcd, LGFX_Sprite& _layoutSprite, 
                      LGFX_Sprite& _ui_sprite0, LGFX_Sprite& ui_sprite1, LGFX_Sprite& ui_sprite2, LGFX_Sprite& _flickUiSprite);
