...
void setup() {
  ...
  ui.begin( &lcd, SHIFT_NUM, 24, 3, true );//lcd, フリックパネル, shiftの数, 色深度, 回転方向,タッチキャリブレーション
  ui.flickSetup( &lcd, layoutSprite, ui_sprite0, ui_sprite1, ui_sprite2, ui_sprite3 ,flickUiSprite);//flickでBTN_4まで使います。
