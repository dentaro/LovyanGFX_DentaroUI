...
void MenuItemSDUpdater::onFocusLoop() {
  ...
  switch (progressDraw) {
    ...
    case 3:
      ...
      // lcd.drawRect(200, 40, 110, 110, 0xFFFF);
      // lcd.drawCentreString("- no image -", 255, 80, &fonts::Font2);
      progressDraw = 9;
      break;
    case 7:
      // lcd.drawJpgFile(SD, imageFilePath.c_str(), 200, 40);
      progressDraw = 9;
      break;
    case 9:
      ++progressDraw;
...
void MenuItemSDUpdater::onDefocus() {
  if (name != "") {
    // lcd.fillRect(200, 40, 120, 140, backgroundColor);
  }
}
